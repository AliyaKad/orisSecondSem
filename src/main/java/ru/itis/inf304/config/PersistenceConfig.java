...
@EnableJpaRepositories("ru.itis.inf304.repository")
...
public class PersistenceConfig implements EnvironmentAware {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factory.setPackagesToScan("ru.itis.inf304.entity");
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactoryBean.setPackagesToScan("ru.itis.inf304.entity");
